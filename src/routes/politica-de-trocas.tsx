...
export const Route = createFileRoute('/politica-de-trocas')({
  head: () => ({
    meta: [
      { title: 'Política de Trocas e Devoluções | WS Suplementos' },
      ...
      { property: 'og:title', content: 'Política de Trocas e Devoluções | WS Suplementos' },
      { property: 'og:description', content: 'Como solicitar troca ou devolução de produtos na WS Suplementos.' },
    ],
  }),
  component: Trocas,
})
...
function Trocas() {
  return (
    <div className="container mx-auto py-12 px-4 md:px-8 max-w-4xl">
      <SEO title="Política de Trocas e Devoluções | WS Suplementos" description="Regras de troca e devolução em conformidade com o CDC." />
      <div className="bg-white rounded-[40px] border p-8 md:p-12 shadow-sm">
        ...
        <div className="prose prose-slate max-w-none prose-headings:italic prose-headings:uppercase prose-headings:font-black prose-headings:tracking-tighter prose-strong:text-slate-900 prose-p:leading-relaxed prose-p:font-medium">
          <p>Na <strong>WS Suplementos</strong>, nossa prioridade é sua satisfação. Caso necessite trocar ou devolver um produto, siga as regras abaixo, que estão em total conformidade com o Código de Defesa do Consumidor (<strong>Lei nº 8.078/90</strong>).</p>
          ...
          <ul>
            ...
            <li><strong>Defeito Comprovado:</strong> Troca por produto idêntico, crédito no site, ou restituição total. Todos os custos de frete são da WS Suplementos.</li>
          ...
          <ul>
            <li><strong>Contato:</strong> E-mail <strong>contato@wsuplemento.site</strong> ou WhatsApp <strong>(34) 99887-7690</strong>.</li>
