...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ultra Gym: loja online de suplementos esportivos com produtos originais, nota fiscal eletrônica, frete grátis acima de R$ 199 e Pix com desconto." },
      { name: "author", content: "Ultra Gym" },
      { name: "google-site-verification", content: "aVyIW5BIKgJU2SMjL7DHC1-YpukeGqiejt5DWIl6SWo" },
      { property: "og:title", content: "Ultra Gym | Suplementos de Alta Performance" },
      { property: "og:description", content: "Whey, Creatina, Pré-Treino e mais. Produtos originais, NF-e e Pix com 10% OFF." },
