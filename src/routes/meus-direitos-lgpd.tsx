...
export const Route = createFileRoute('/meus-direitos-lgpd')({
  head: () => ({
    meta: [
      { title: 'Meus Direitos como Titular dos Dados (LGPD) | WS Suplementos' },
      { name: 'description', content: 'Conheça e exerça gratuitamente os direitos garantidos pela LGPD sobre seus dados pessoais tratados pela WS Suplementos.' },
    ],
  }),
...
const RIGHTS = [
  { title: 'Confirmação da existência de tratamento', body: 'Saber se a WS Suplementos trata dados pessoais sobre você. (Art. 18, I)' },
...
function LgpdRights() {
  return (
    <div className="container mx-auto py-12 px-4 md:px-8 max-w-4xl">
      <SEO title="Meus Direitos como Titular dos Dados | WS Suplementos" description="Conheça e exerça os direitos LGPD sobre seus dados pessoais — de forma gratuita e facilitada." />
      ...
      <div className="bg-white rounded-[40px] border p-8 md:p-12 shadow-sm">
        ...
        <div className="prose prose-slate max-w-none prose-headings:italic prose-headings:uppercase prose-headings:font-black prose-headings:tracking-tighter prose-strong:text-slate-900 prose-p:leading-relaxed prose-p:font-medium">
          <p>A <strong>Lei Geral de Proteção de Dados (LGPD — Lei 13.709/2018)</strong> garante a você, titular dos dados pessoais, uma série de direitos sobre as informações que a WS Suplementos coleta e trata. Esta página explica cada um deles e como exercê-los — de forma <strong>gratuita</strong> e <strong>facilitada</strong>.</p>
          ...
          <div className="not-prose bg-slate-50 border rounded-2xl p-6 my-6">
            ...
            <a href="mailto:dpo@wsuplemento.site?subject=Solicita%C3%A7%C3%A3o%20LGPD%20-%20Titular%20de%20Dados" className="text-orange-600 font-black italic text-lg">dpo@wsuplemento.site</a>
